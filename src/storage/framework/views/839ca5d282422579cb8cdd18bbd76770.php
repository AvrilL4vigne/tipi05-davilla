<section class="services-section" style="background-image: url(https://via.placeholder.com/1920x1080);">
        <div class="auto-container">
            ...
            <div class="sec-title text-center">
                <div class="divider"><img src="<?php echo e(asset('images/icons/divider_1.png')); ?>" alt=""></div>
            ...
            <div class="services-carousel owl-carousel owl-theme">
                        <?php $__currentLoopData = $filtroCategoria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $linha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- Service Block -->
                <div class="service-block">
                    <div class="inner-box">
                        <div class="image-box">
                            ...
                            <!-- cake img -->
                            <figure class="image"><img src="<?php echo e(asset("davilla/images/services/services-$linha->id_categoria.svg")); ?>" alt=""></figure>
                        </div>
                        <h3>
                        <?php echo e($linha->nome_categoria); ?> </h3>
                        <p><?php echo e($linha->descricao_categoria); ?></p>
                    </div>
                </div>
    ...
    </section><?php /**PATH /var/www/html/resources/views/site/home/services.blade.php ENDPATH**/ ?>