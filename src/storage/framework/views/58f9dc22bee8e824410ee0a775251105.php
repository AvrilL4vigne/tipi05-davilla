    ...
    <section class="pricing-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                <div class="divider"><img src="<?php echo e(asset('davilla/images/icons/divider_1.png')); ?>" alt=""></div>
                <h2>Sabores e Valores</h2>
            </div>

            <div class="row">
                <?php $__currentLoopData = $listaProduto->shuffle()->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $linha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- Pricing Table -->
                <div class="pricing-table tagged col-xl-3 col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="pricing-highlight">
                            ...
                            <h5><?php echo e($linha->destaque_produto == 'SIM' ? 'off' : ''); ?></h5>
                        </div>

                        <div class="image-box">
                            <figure class="image"><img src="<?php echo e(asset("davilla/images/produto/$linha->slug_produto.png")); ?>" alt="<?php echo e($linha->nome_produto); ?>"></figure>
                        </div>
                        ...
                        <div class="title-box">
                            <h3><?php echo e($linha->nome_produto); ?></h3>
                        </div>
                        <div class="price-box">
                            <div class="price"><sup>R$</sup><?php echo e($linha->valor_produto); ?></div>
                            <span class="title"><?php echo e($linha->nome_produto); ?></span>
                        </div>
                        <div class="table-content">
                            <ul>
                                <li><span><?php echo e($linha->descricao_produto); ?></span></li>
                                <li><span><?php echo e($linha->tamanho_produto); ?></span></li>

                            </ul>
                        </div>
                        <div class="table-footer">
                            <a href="<?php echo e(route('cardapio.produto', $linha->slug_produto)); ?>" class="theme-btn btn-style-two regular"><span></span>Reserva<span></span></a>
                        </div>
                    </div>
                </div>
    ...
    <!--End Pricing Section --><?php /**PATH /var/www/html/resources/views/site/home/pricing.blade.php ENDPATH**/ ?>