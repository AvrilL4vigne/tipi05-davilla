            ...
            <div class="mixitup-gallery">
                ...
                <div class="filters clearfix">
                    <ul class="filter-tabs filter-btns clearfix">
                        ...
                        <li class="filter" data-role="button" data-filter=".categoria-<?php echo e($linha->id_categoria); ?>">Sweet Cakes
                            <?php echo e($linha->nome_categoria); ?>
                ...
                <div class="filter-list row">
                    ...
                    <?php $__currentLoopData = $listaProduto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $linha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 
                        <!-- Portfolio Block Four -->
                        <div class="portfolio-block-four mix categoria-<?php echo e($linha->id_categoria); ?> sweet-cakes col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo e(asset('davilla/images/'. $linha->foto_produto)); ?>" alt=""></figure>
                                    <div class="hover-effect">
                                        ...
                                        <a href="<?php echo e(route('cardapio.produto', $linha->slug_produto)); ?>" class="link"></a>
                                    </div>
                                </div>
                                ...
                                <div class="lower-content">
                                    <div class="title-box">
                                        <h3>
                                            <a href="<?php echo e(route('cardapio.produto', $linha->slug_produto)); ?>"><svg class="div_left" viewBox="0 0 152 51">
                                                ...
                                                </svg><?php echo e($linha->nome_produto); ?><svg class="div_right" viewBox="0 0 152 51">
                                    ...
                                    <div class="text"><?php echo e(Illuminate\Support\Str::limit($linha->descricao_produto, 100)); ?></div>
 
                                    <div class="price"><?php echo e(number_format($linha->valor_produto, 2, ',', '.   ')); ?></div>
                                </div>
                            </div>
                        </div>
    ...
    <!--End Projects Sections --><?php /**PATH /var/www/html/resources/views/site/cardapio/portfolio-section.blade.php ENDPATH**/ ?>