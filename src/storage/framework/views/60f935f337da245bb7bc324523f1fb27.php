                            ...
                            <div class="basic-details">
                                <div class="row clearfix">
                                    <div class="image-column col-md-6 col-sm-12">
                                        <figure class="image">
                                            <a href="<?php echo e(asset('davilla/images/'. $produto->foto_produto)); ?>" class="lightbox-image" title="<?php echo e($produto->nome_produto); ?>">
                                                <img src="<?php echo e(asset('davilla/images/'. $produto->foto_produto)); ?>" alt="<?php echo e($produto->nome_produto); ?>">
                                    ...
                                    <div class="info-column col-md-6 col-sm-12">
                                        <div class="details-header">
                                            <h4><?php echo e($produto->nome_produto); ?></h4>
                                            <div class="rating">
                                ...
                                <div class="prod-tabs tabs-box">
                                    ...
                                    <div class="tabs-content">
                                        ...
                                        <div class="tab active-tab" id="prod-reviews">
                                            <h2 class="title">Avaliações para <?php echo e($produto->nome_produto); ?></h2>
                                    ...
                                    <div class="shop-item col-lg-4 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                ...
                                                <figure class="image"><a href="<?php echo e(asset('davilla/images/'. $produtoRelacionado->foto_produto)); ?>"><img src="<?php echo e(asset('davilla/images/'. $produtoRelacionado->foto_produto)); ?>" alt=""></a></figure>
                                                <div class="btn-box"><a href="#">Add a reserva</a></div>
                                            </div>
                                            <div class="lower-content">
                                                <h4 class="name"><a href="<?php echo e($produtoRelacionado->slug_produto); ?>"><?php echo e($produtoRelacionado->nome_produto); ?></a></h4>
                                                ...
                                                <div class="price">R$ <?php echo e(number_format($produtoRelacionado->valor_produto, 2, ',', '.')); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="shopping-cart">
                                        <ul class="shopping-cart-items">
                                            <li class="cart-item">
                                                <img src="<?php echo e(asset('davilla/images/pricing.png')); ?>" alt="#" class="thumb" />
    ...
    <!--End Sidebar Page Container--><?php /**PATH /var/www/html/resources/views/site/produto/slidebar-produto.blade.php ENDPATH**/ ?>