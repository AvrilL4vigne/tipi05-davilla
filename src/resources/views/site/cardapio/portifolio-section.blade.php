    ...
    <div class="container-fluid">
        ...
        <div class="mixitup-gallery">
            ...
            <div class="filter-list row">
                ...
                <div class="portfolio-block-four all mix .categoria-{{ $linha->id_categoria }} col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                        ...
                        <div class="lower-content">
                            ...
                            <div class="text">Dapibus sapien felis at sit, pulvinar dignissimos et per aliquam, ut
                                fusce, vitae donec vitae non senectus cillum ultric</div>
                        </div>
                    </div>
                </div>
