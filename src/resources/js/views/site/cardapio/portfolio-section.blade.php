            ...
            <div class="mixitup-gallery">
                ...
                <div class="filters clearfix">
                    <ul class="filter-tabs filter-btns clearfix">
                        ...
                        <li class="filter" data-role="button" data-filter=".categoria-{{ $linha->id_categoria }}">Sweet Cakes
                ...
                <div class="filter-list row">
                    ...
                    @foreach($listaProduto as $linha)
                        ...
                        <div class="portfolio-block-four mix categoria-{{ $linha->id_categoria }} sweet-cakes col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image-box">
                                ...
                                <div class="lower-content">
                                    <div class="title-box">
                                        <h3>
                                            <a href="{{ route('cardapio.produto', $linha->slug_produto) }}"><svg class="div_left" viewBox="0 0 152 51">
